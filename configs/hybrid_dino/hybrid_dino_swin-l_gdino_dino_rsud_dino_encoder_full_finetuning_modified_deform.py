...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'gdino_ref_deformer.cross_attn': dict(lr_mult=0.2),
            'gdino_ref_deformer.gate': dict(lr_mult=2.0),
            'gdino_ref_deformer.alpha': dict(lr_mult=1.0),
            'gdino_ref_deformer.ln_': dict(lr_mult=0.5),
