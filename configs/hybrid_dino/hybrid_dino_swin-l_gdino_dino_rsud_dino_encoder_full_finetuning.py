...
# DINO  Train and DINO Test pipeline
train_pipeline = [
...
train_img_prefix = data_root + 'images/train/'   # path where train images are stored
val_img_prefix = data_root + 'images/val/'       # path where val images are stored
...
# default_hooks = dict(visualization=dict(score_thr=0.07))