...
val_dataloader = dict(
    dataset=dict(
        ...
        metainfo=metainfo,
        data_root=data_root,
        ann_file='/home/poonam_rajput/scratch/mmdetection/Test_analysis/merged_instances_val2017.json',
        data_prefix=dict(img='images/val')))

test_dataloader = val_dataloader

# val_evaluator = dict(ann_file=data_root + 'annotations/instances_val2017_subset_dino_missed.json')
val_evaluator = dict(ann_file='/home/poonam_rajput/scratch/mmdetection/Test_analysis/merged_instances_val2017.json')
