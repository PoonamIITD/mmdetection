...
# custom_imports = dict(imports=['mmdet.engine.hooks.hdino_decoder_warmup_hook'], allow_failed_imports=False)
...
val_evaluator = dict(ann_file=data_root + 'annotations/merged_instances_val2017_codetr_final.json')
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            # 'lora': dict(lr_mult=2.0),
        }))

# custom_hooks = [
#     dict(type='UnfreezeDecoderHook', unfreeze_epoch=3)
# ]