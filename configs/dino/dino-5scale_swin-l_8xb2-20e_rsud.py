...
val_ann_file = data_root + '/annotations/instances_train2017.json'
# val_ann_file = data_root + '/annotations/merged_instances_val2017_codetr_final.json'
...
val_img_prefix = images_data_root + '/train/'
