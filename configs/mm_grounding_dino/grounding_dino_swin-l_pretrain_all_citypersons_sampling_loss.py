...
data_root = '/home/poonam_rajput/scratch/dataset/CityPersons_dataset/'
...
class_name =('pedestrian','sitting person','rider','ignore', )
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='annotations/train_instances.json',
...
val_dataloader = dict(
    dataset=dict(
        ...
        metainfo=metainfo,
        data_root=data_root,
        ann_file='annotations/val_instances.json',
        # ann_file ='annotations/val_instances_with_occlusion.json',
        # ann_file='annotations/filtered_val_subset_suppression_queries.json',
...
val_evaluator = dict(
    ...
    # ann_file=data_root + 'annotations/val_instances_with_occlusion.json',
    # ann_file=data_root + 'annotations/filtered_val_subset_suppression_queries.json',
    metric='bbox',
    format_only=False)
