...
val_dataloader = dict(
    dataset=dict(
        ...
        metainfo=metainfo,
        data_root=data_root,
        ann_file='annotations/instances_validation_merged_mannual.json',
        ...
        # ann_file='annotations/new_instances_test2017.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/instances_validation_merged_mannual.json',
    # ann_file=data_root + 'annotations/new_instances_test2017.json',
