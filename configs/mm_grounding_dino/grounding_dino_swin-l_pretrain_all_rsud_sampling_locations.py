...
model = dict(
    ...
    # bbox_head=dict(encoder_assigner=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file='annotations/train_with_visibility.json',
...
#         ann_file ='annotations/impainted_intances_list.json',
#         data_prefix=dict(img='images/val_suppression_queries_non_impainted')))
...
val_evaluator = dict(
    ...
    # ann_file = data_root + 'annotations/impainted_intances_list.json',
    metric='bbox',
    format_only=False)
