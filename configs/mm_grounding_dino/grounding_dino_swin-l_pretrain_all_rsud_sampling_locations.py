...
val_dataloader = dict(
    dataset=dict(
        ...
        # ann_file ='annotations/val_with_visibility.json',
        data_prefix=dict(img='images/val_suppression_queries')))
...
val_evaluator = dict(
    ...
    # ann_file=data_root + 'annotations/val_with_visibility.json',
    metric='bbox',
    format_only=False)
