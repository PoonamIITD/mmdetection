...
data_root = '/home/poonam_rajput/scratch/dataset/UVH_dataset/'
class_name = ('Hatchback','Sedan','SUV','MUV','Bus','Truck','Three-wheeler','Two-wheeler','LCV','Mini-bus','Tempo-traveller','Bicycle','Van','Others')
...
model = dict(
    ...
    test_cfg = dict(max_per_img=900), # for test time noise addition
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='annotations/train_split_mv.json',
...
val_dataloader = dict(
    dataset=dict(
        ...
        metainfo=metainfo,
        data_root=data_root,
        ann_file='annotations/test_mv_25.json',
        data_prefix=dict(img='images/test')))

test_dataloader = val_dataloader

val_evaluator = dict(ann_file=data_root + 'annotations/test_mv_25.json')
