...
class HybridDINO(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        # Names of prompt parameters to unfreeze
        PROMPT_NAMES = {
            "prompt_embeddings",
        ...
        # Unfreeze only prompt parameters
        for name, param in self.backbone.named_parameters():
            if any(pn in name for pn in PROMPT_NAMES):
        ...
        # Unfreeze only text_prompts
        self.language_model.text_prompts.requires_grad = True
