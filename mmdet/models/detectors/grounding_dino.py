...
class GroundingDINO(DINO):
    ...
    def forward_transformer(
        ...
        decoder_outputs_dict = self.forward_decoder(**decoder_inputs_dict, dn_meta=dn_meta)
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        if self.use_autocast:
            ...
            visual_features = self.extract_feat(batch_inputs)
        head_inputs_dict,_,_,_ = self.forward_transformer(visual_features, text_dict,
                                                    batch_data_samples)

        losses = self.bbox_head.loss(
            **head_inputs_dict, batch_data_samples=batch_data_samples, sampling_locations=torch.stack(self.decoder.all_sampling_locations), 
            reference_points=torch.stack(self.decoder.all_reference_points))
    ...
    def predict(self, batch_inputs, batch_data_samples, rescale: bool = True):
        ...
        if isinstance(text_prompts[0], list):
            ...
            # save_dir = "debug_outputs_7_repulsion_loss_unconstrained"
